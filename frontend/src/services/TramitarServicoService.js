...
class TramitarServicoService {
    ...
    async obterTodos() {
        const response = await fetch(`${API_BASE_URL}/tramitar`, {
            headers: {
    ...
    async atualizar(idTramitar, TramitarDados) {
        ...
        try {
            const response = await fetch(`${API_BASE_URL}/tramitar/${idTramitar}`, {
                method: 'PUT',
                headers: {
                    'Content-Type': 'application/json'
                },
    ...
    async obterPorId(id) {
        const response = await fetch(`${API_BASE_URL}/tramitar/${id}`, {
            headers: {
                'Content-Type': 'application/json'
            }
        })
    ...
    async filtrar(termoBusca) {
        const response = await fetch(`${API_BASE_URL}/tramitar/filtrar/${termoBusca}`, {
            headers: {
                'Content-Type': 'application/json'
            }
        })
